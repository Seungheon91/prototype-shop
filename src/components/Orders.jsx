    ...
    <div className="order">
        ...
        {orders.map(order => {
          ...
          return (<div className="item" key={id}>
            ...
            <div className="action">
              ...
              <button className="btn btn-link" onClick={click}><i className="icon icon--cross"></i></button>
            </div>
          </div>);
        })}
      </div>
      <div className="total">
        ...
        <div className="item">
          ...
          <button className="btn btn-link" onClick={removeAll}><i className="icon icon--delete"></i></button>
        </div>
